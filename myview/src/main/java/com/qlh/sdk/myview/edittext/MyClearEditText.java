package com.qlh.sdk.myview.edittext;
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
        ...
        mDrawableHeight = ta.getDimensionPixelSize(R.styleable.editTextStyle_edt_delete_icon_height,0);

        ta.recycle();

        int width = mDrawableWidth == 0?(int) getResources().getDimension(R.dimen.d16):mDrawableWidth;
        int height = mDrawableHeight == 0?(int) getResources().getDimension(R.dimen.d16): mDrawableHeight;
