...
import com.qlh.sdk.myview.camera.base.SizeMap;
...
public class CameraImpl {
        ...
        if (!isPictureCaptureInProgress.getAndSet(true)) {
            mCamera.takePicture(null, null, null, new Camera.PictureCallback() {
                ...
                public void onPictureTaken(byte[] data, Camera camera) {
                    ...
                    mCallback.onPictureTaken(CameraImpl.this, data,ImageUtils.getOrientation(data));
   ...
   private void adjustCameraParameters() {
    ...
    public abstract static class Callback {
       ...
       public void onPictureTaken(CameraImpl camera, byte[] data,int rotate){}
