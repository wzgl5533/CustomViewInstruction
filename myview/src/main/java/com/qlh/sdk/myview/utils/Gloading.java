...
public class Gloading {
    ...
    public interface Adapter {
         ...
         * @see Holder
         */
        View getView(Holder holder, View convertView,int status,String msg);
    }
    ...
    public static class Holder {
         ...
         * @param status status
         * @see #showLoading(String msg)
         * @see #showLoadFailed(String msg)
         * @see #showLoadSuccess(String msg)
         * @see #showEmpty()
         */
